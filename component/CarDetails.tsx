            ...
            <div className='flex min-h-full items-center justify-center p-4 text-center'>
              ...
              >
                <DialogPanel className={"relative w-full max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-xl transition-all flex flex-col gap-5"}>
                  <button
                    type='button'
                    className='absolute top-2 right-2 z-10 w-fit p-2 bg-orange-100 rounded-full'
                    onClick={closeModal}
                  >
                    <Image
                      src={"/close.svg"}
                  ...
                  <div className="flex-1 flex flex-col gap-3">
                    <div className="relative w-full h-40 bg-pattern bg-cover bg-center rounded-lg  bg-[url('/pattern.png')] ">
                      <Image 
                        src={"/hero.png"}
                        alt='car model'
                        fill
                    ...
                    <div className='flex gap-3'>
                      <div className='flex-1 relative w-full h-24 bg-orange-100 rounded-lg'>
                        <Image 
                          src={"/hero.png"}
                          alt='car model'
                          fill
